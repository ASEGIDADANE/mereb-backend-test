...
exports.uploadCSV = functions.https.onRequest(async (req, res) => {
    // Enable CORS
    ...
    try {
        ...
        bb.on('finish', async () => {
            ...
            try {
                ...
                const resultFileName = `processed_${Date.now()}_${fileName}`;
                const file = bucket.file(resultFileName);
                await file.save(resultCSV, {
                    metadata: {
...
//# sourceMappingURL=uploadCSV.js.map